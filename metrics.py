...
class _RankingMetricImpl(six.with_metaclass(abc.ABCMeta, object)):
...
class _NDCGMetricImpl(_RankingMetricImpl):
    ...
    def __init__(self,
                 ...
                 ragged=False):
        """Constructor."""
        super(_NDCGMetricImpl, self).__init__(ragged=ragged)
        self._name = name
        self._topn = topn
